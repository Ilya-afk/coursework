...
class Ui_update_user_window(object):
    def setupUi(self, update_user_window):
        update_user_window.setObjectName("update_user_window")
        update_user_window.resize(484, 224)
        self.centralwidget = QtWidgets.QWidget(update_user_window)
        ...
        self.update_user_button.setGeometry(QtCore.QRect(370, 130, 81, 41))
        ...
        self.lineEdit_user_id.setGeometry(QtCore.QRect(80, 130, 131, 20))
        self.lineEdit_user_id.setObjectName("lineEdit_user_id")
        update_user_window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(update_user_window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 484, 21))
        self.menubar.setObjectName("menubar")
        update_user_window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(update_user_window)
        self.statusbar.setObjectName("statusbar")
        update_user_window.setStatusBar(self.statusbar)

        self.retranslateUi(update_user_window)
        QtCore.QMetaObject.connectSlotsByName(update_user_window)

    def retranslateUi(self, update_user_window):
        _translate = QtCore.QCoreApplication.translate
        update_user_window.setWindowTitle(_translate("update_user_window", "MainWindow"))
        self.label.setText(_translate("update_user_window", "surname"))
        self.label_2.setText(_translate("update_user_window", "first_name"))
        self.label_3.setText(_translate("update_user_window", "middle_name"))
        self.label_4.setText(_translate("update_user_window", "phone_number"))
        self.label_5.setText(_translate("update_user_window", "address"))
        self.label_6.setText(_translate("update_user_window", "balance"))
        self.update_user_button.setText(_translate("update_user_window", "update_user"))
        self.label_7.setText(_translate("update_user_window", "user_id"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    update_user_window = QtWidgets.QMainWindow()
    ui = Ui_update_user_window()
    ui.setupUi(update_user_window)
    update_user_window.show()
    sys.exit(app.exec_())
